...
import haijie.Day22.model.Dependant;
...
public class EmployeeRepoImpl implements EmployeeRepo {
    ...
    public List<Employee> retrieveEmployeeList() {
        String selectSQL = "select e.id emp_id, e.first_name, e.last_name,e.salary,"+
            "d.id dep_id,d.dname,d.relationship,d.birth_date from employee e "+
            "inner join dependant d "+
            "on e.id = d.employee_id";

        //result set extractor query
        return jdbcTemplate.query(selectSQL, new ResultSetExtractor<List<Employee>>() {
            ...
            public List<Employee> extractData(ResultSet rs) throws SQLException, DataAccessException {
                ...
                while(rs.next()){
                    ...
                    dep.setFullname(rs.getString("dname"));
                    dep.setRelatiomship(rs.getString("relationship"));
